...
"MAJENTA"="#822b52")
	var/prim
	var/sec
	var/choice = input(src, "Choose a Primary Color", "ELDERMOOR") as anything in lordcolors
	if(choice)
		prim = lordcolors[choice]
		lordcolors -= choice
	choice = input(src, "Choose a Secondary Color", "ELDERMOOR") as anything in lordcolors
	if(choice)
