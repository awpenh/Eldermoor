...
/datum/controller/subsystem/ticker/proc/declare_completion()
	...
	to_chat(world, "<BR><BR><BR><span class='reallybig'>So ends this tale of Eldermoor.</span>")
	get_end_reason()
		...
		if(C.check_for_lord)
			if(!C.check_for_lord(forced = TRUE))
				end_reason = pick("Without a King, they were doomed to become slaves of Zizo.",
								...
								"Without a King, the town was left to rot, picked apart by carrion eaters.")
...
//			end_reason = "The town was abandoned."
		...
		if(C.vampire_werewolf() == "werewolf")
			end_reason = "The Werevolves formed an unholy clan, marauding Eldermoor until the end of its daes."
