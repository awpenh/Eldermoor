...
#define ALL_RACES_LIST			list("human", "rakshari", "dwarf", "elf", "tiberian", "anakim", "halforc", "orc", "zizombie")
...
#define CTAG_TOLGARRISON	"CAT_TOLGARRISON"
