/datum/migrant_role/grenzelhoft/count
	...
	greet_text = "A Count hailing from the Grenzelhoft Imperiate, here on an official visit to the Isle of the Albia alongside his beloved convoy and spouse."
...
/datum/migrant_role/grenzelhoft/countess
	...
	greet_text = "A Countess hailing from the Grenzelhoft Imperiate, here on an official visit to the Isle of the Albia alongside her beloved convoy and husband."
...
/datum/migrant_role/grenzelhoft/grenzelhoft_knight
	...
	greet_text = "Your liege, the count and the countess have both took the duty gaved by the Kaiser itself to voyage to the Isle of Albia, ensure their survival and obey their orders."
	allowed_sexes = list(MALE)
...
/datum/migrant_role/grenzelhoft/grenzelhoft_men_at_arms
	...
	greet_text = "You and your fellows are men at arms from Grenzelhoft, except your local liege has been sent to the Isle of Albia, obey the Ritter and make sure the nobles goes home."
	allowed_sexes = list(MALE)
	allowed_races = list(
		"Humen",
		"Dwarf"
...
/datum/migrant_wave/grenzelhoft_visit
	...
	greet_text = "The Kaiser of the Grenzelhoft Imperiate has sent a diplomatic envoy to engage into diplomacy within the Kingdom of Eldermoor."
