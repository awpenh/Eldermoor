...
/obj/item/paper/heartfelt/goal3
	info = "Establish a diplomatic alliance with the King of Eldermoor to strengthen the relationship between Heartfelt and Eldermoor."
...
/obj/item/paper/heartfelt/goal1
	info = "Negotiate trade agreements with merchants in Eldermoor to facilitate the exchange of goods and resources between the two realms."
