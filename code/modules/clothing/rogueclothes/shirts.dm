...
/obj/item/clothing/suit/roguetown/shirt/dress/royal
	...
	name = "royal gown"
	desc = "An elaborate ball gown, a favoured fashion of queens and elevated nobility in Albia."
...
/obj/item/clothing/suit/roguetown/shirt/dress/royal/princess
	slot_flags = ITEM_SLOT_SHIRT|ITEM_SLOT_ARMOR
	name = "pristine dress"
	desc = "A flowy, intricate dress made by the finest tailors in the land for the King's children."
	icon_state = "princess"
	boobed = TRUE
...
/obj/item/clothing/suit/roguetown/shirt/dress/royal/prince
	...
	desc = "A gold-embroidered dress shirt specially tailored for the King's children."
	icon_state = "prince"
	boobed = TRUE
...
/obj/item/clothing/suit/roguetown/shirt/jester/alt
	slot_flags = ITEM_SLOT_SHIRT|ITEM_SLOT_ARMOR
	name = "jester's tunick"
	desc = "Just remember that the last laugh is on you."
	body_parts_covered = CHEST|GROIN|ARMS|VITALS
	icon_state = "jestershirt_alt"
	icon = 'icons/roguetown/clothing/shirts.dmi'
	mob_overlay_icon = 'icons/roguetown/clothing/onmob/shirts.dmi'
	sleeved = 'icons/roguetown/clothing/onmob/shirts.dmi'
	boobed = TRUE
