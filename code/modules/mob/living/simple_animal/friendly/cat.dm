...
/mob/living/simple_animal/pet/cat
	name = "cat"
	desc = "A nuisance and a valued, pest-killing companion. Also symbols of the benevolent side of Saint Mikros for their enmity with vermin."
...
/mob/living/simple_animal/pet/cat/rogue/black
	name = "black cat"
	desc = "Possessed of lamplike eyes and a meow that sounds like the rattle of bones. Black cats are sacred to Labbeus, said to bring wandering spirits to the Carriageman."
	gender = FEMALE
