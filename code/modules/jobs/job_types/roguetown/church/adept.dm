/datum/job/roguetown/adept
	...
	tutorial = "You were a convicted criminal, the lowest scum of Eldermoor. Your master, the Inquisitor, saved you from the gallows and has given you true purpose in service to Psydon. You will not let him down."
