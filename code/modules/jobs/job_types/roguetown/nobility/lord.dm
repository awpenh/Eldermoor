...
/datum/job/roguetown/lord/after_spawn(mob/living/L, mob/M, latejoin = TRUE)
	...
	if(L.gender == MALE)
		...
		to_chat(world, "<b><span class='notice'><span class='big'>[L.real_name] is King of Eldermoor.</span></span></b>")
		to_chat(world, "<br>")
	else
		SSfamilytree.AddRoyal(L, FAMILY_MOTHER)
		to_chat(world, "<b><span class='notice'><span class='big'>[L.real_name] is Queen of Eldermoor.</span></span></b>")
		to_chat(world, "<br>")
