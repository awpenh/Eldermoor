...
/obj/item/rogueweapon/shield/wood/attack_right(mob/user)
	if(!overlays.len)
		...
		var/picked_name = input(user, "Choose a Heraldry", "ELDERMOOR", name) as null|anything in sortList(GLOB.IconStates_cache['icons/roguetown/weapons/wood_heraldry.dmi'])
		if(!picked_name)
			picked_name = "none"
...
/obj/item/rogueweapon/shield/tower/metal/attack_right(mob/user)
	if(!overlays.len)
		...
		var/picked_name = input(user, "Choose a Heraldry", "ELDERMOOR", name) as null|anything in sortList(GLOB.IconStates_cache['icons/roguetown/weapons/shield_heraldry.dmi'])
		if(!picked_name)
			picked_name = "none"
