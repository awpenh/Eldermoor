...
/obj/effect/proc_holder/spell/invoked/avert
	name = "Borrowed Time"
	desc = "Shield someone from the Reaper's gaze, preventing them from slipping into death for as long as your faith and fatigue may muster."
...
/obj/effect/proc_holder/spell/invoked/avert/cast(list/targets, mob/living/carbon/human/user)
	...
	user.visible_message(span_notice("Whispering motes gently bead from [user]'s fingers as [user.p_they()] place a hand near [living_target], scriptures of the Reaper spilling from their lips..."), span_notice("I stand beside [living_target] and utter the hallowed words of Aeon's Intercession, staying Her grasp for just a little while longer..."))
...
/obj/effect/proc_holder/spell/targeted/abrogation
	...
	associated_skill = /datum/skill/magic/holy
	invocation = "The Reaper rejects your presence!"
